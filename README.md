Вибачайте за ці труднощі! Помилка виникає через те, що GitHub Mermaid іноді конфліктує з кириличними символами всередині текстових блоків, якщо вони не обгорнуті в подвійні лапки " ". Також я прибрав складне форматування (теги <b>, <i>), щоб парсер точно «проковтнув» код.

Ось максимально очищений та перевірений код. Скопіюйте його саме так:
